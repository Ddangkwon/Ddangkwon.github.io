...
int main() {
    ...
    if (auto lb = score.lower_bound("Lee"); lb != score.end())
        cout << "lower_bound(Lee) → " << lb->first << '\n';

    if (auto ub = score.upper_bound("Lee"); ub != score.end())
        cout << "upper_bound(Lee) → " << ub->first << '\n';
