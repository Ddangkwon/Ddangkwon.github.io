...
int main(void)
{
    ...
    for(int i = 0; i < N; i++){
        ...
        string word;
        cin >> cmd >> word;
        auto it = member.find(word);
        
        // validate
        if(cmd == 1){
            answer = (int)(it != member.end());
        }
        // activate
        else if(cmd == 2){
            answer = (int)(it != member.end() && it->second == 1);
        }
        // signup
        else if(cmd == 3){
            member.insert({word, 0});
            answer = (int)member.size();
        }
        // close
        else if(cmd == 4){
            if(it != member.end()){
